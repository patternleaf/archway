var OPC_PORT = 7890, COMMAND_PIXELS = 0;
...
chrome.app.runtime.onLaunched.addListener(function() {
    ...
    var handleOPCFrame = function(frame) {
        ...
        gOPCFramesRecieved++;
        if (time > gFrameReportTime + 1e3) {
            trigger("opcFrameReport", {
                nFrames: gOPCFramesRecieved
            });
